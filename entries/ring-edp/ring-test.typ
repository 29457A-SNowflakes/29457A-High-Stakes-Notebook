...
= Introduction
In order to confirm we have met our success criteria (as defined by the identify page) we ran tests to confirm its ability to intake rings, elevate them and score them onto a clamped mogo.
\
\
= Tests
We ran 3 sets of tests and made note as to how often the ring was successfully scored in comparison to the number of rings it intook. 
\
...
- We layed out the field in a game configuration and drove the robot in the allotted match time.
= Results:
#align(center)[
...
= Analysis:
We ideally want accuracy to be close to 100% as possible and felt these results were unacceptable. The mechanism failing to score between 30-40% of the times would significantly negatively impact our game performance. Interestingly, the robot scored nominally (10%) better when in motion compared to at rest. Understanding why this is the case can lead us to having more consistent results. 
\
\
...
= Conclusion 
As is demonstrated in the graph above, implementing our solutions and widening the arc significantly improved scoring consistency raising it by around 20%, which is much closer to the goal of 100% and much more acceptable.