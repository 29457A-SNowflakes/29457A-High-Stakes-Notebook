...
as with all elements of our robot there is a clear steps followed to build our intake and these are diluted here:
= Parts list:
...
== Step 3:
finally we added the flex wheels and the motor to the rest of the frame, we used a 6T sprocket and chain to link the motor to the axel that the flex wheels are on on a 1:1 ratio, to make sure the intake is running at a suitably fast speed to pick up rings at the desired rate 
