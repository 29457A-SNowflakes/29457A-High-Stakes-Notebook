...
#show: create-body-entry.with(
  title: "V2 Identify: First Stage Intake",
  type: "identify",
...
= What went well
The flex wheels were able to do a somewhat decent job at intaking rings once partially sucked into the intake, allowing for a transition to the hooks mechanism.
= To be improved
