...
#align(center)[
  #grid(columns: 2, gutter: 20pt,
    [#figure(image("./imgs/MogoMechBuilt.jpg", height: 150pt, width: 120pt), caption: [Here is the mogo clamo that we built using the instructions and parts listed here ])],
