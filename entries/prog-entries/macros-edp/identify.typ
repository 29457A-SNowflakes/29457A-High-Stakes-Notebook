...
- Scoring
  ...
  - This means lifting the ring to the correct height to put ring on stake
  - This can encompass both alliance and neutral stakes
- Flipping/De-flipping goals
  - A useful feature of our wall stake mech is the ability to use it as a way to deffensively flip goals to avoid manipulation -- or to 'de-flip' them for negative or positive corner match play
...
While less important, as it does not affect a match or competition, making the subsytem easy to use in code can drasticallyt aid with the use of it during autonomous -- therefore reducing time spent programming autonomous routines#footnote([This also reduces my chance of getting a headache.]).