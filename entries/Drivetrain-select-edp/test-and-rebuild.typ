...
=== Method:
- Place a single motor on one of the slots for the motors on _one side_
- Spin motor at max RPM (brain's device control panel)
- Take reading of motor power consupmtion
- Take notes on the stability of the power consupmtion
- Take motor our and allow to cool
...
#align(center)[
  #box(inset: 15pt, radius: 8pt, fill: gradient.linear(rgb(4, 176, 27), rgb(27, 107, 38), angle:-45deg))[
    #table(columns: 5, rows: 4,
      [Motor Speed / RPM], [], [Power Consupmtion / W], [], [],
