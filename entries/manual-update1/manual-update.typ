...
As head of tactics, we decided that it should be my responisiblity to know absolutely everything in the game manual, so, if it comes to it in a match, I would be able to work out the best stratergy in certain situations that would get us more points, or be able to stop us from getting violations in other cases.
...
I believe part 2 and 3 are especially significant, as in the previous version, the stake didn't need to be as 'upright', and this change makes it so its harder to score, as if the stake is tipped over by the opposing alliance, it will not get the corner modifier.

Part 3 is also significant as the rule used to be so the base of the stake must contact the floor of the corner, but now the edge of the base can just overhang, making it slightly easier for the mobile goal to be considered as placed.
...
+ Rings cannot exceed the maximum nhumber of rings for the stake

However, the new SC3 rule overhauled these conditons, and only made the last 2 relevant. THIS IS LITERALLY GAME CHANGING! Because of this update, if a ring is 'on' a stake, it is pretty much guarunteed to be scored, whereas before, teams had to think about whether their robot was touching the rings or if the stake is toppled over, but now these 2 conditions are irrelevant. This will make scoring much easier, and i can imagine we will see many more points given to both teams in future games.
...
Althought the AWP is much harder to obtain,I believe this is a positive change, as, from my experience, in previous games, the AWP was sometimes too easy to get, and therfore the tournaments relied less on the actual driver controlled section and teams could easily get AWP's through the Autonomous Win Point. However, if a team can perfect their autonomous, they could consistently get the AWP, kbut this will require a lot of work and i belive its a good change.
...
This would stop teams from trying to descore even-points neutral wall stakes, as there would be the fear of pushing the rings out of the field instead of back onto the floor tiles, and therefore would incentivise teams to put rings on a wall stake that allready has some of the other alliances rings as they knew there would be little risk of another team trying to descore, as they would be worried that they would descore their own rings, and possibly get a violation, as well as losing some of their own points.

However, due to the new rule only applying to the enemy alliance's rings, this means teams will feel more comfortable descoring their own rings, as there is less risk of getting a violation. I believe this rule change makes more sense, as teams shouldn't be puished for losing their own points.