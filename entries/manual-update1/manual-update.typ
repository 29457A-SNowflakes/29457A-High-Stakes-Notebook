...
As head of tactics, we decided that it should be my responsiblity to know absolutely everything in the game manual as this helps me be able to work out the best stratergy in certain situations that would get us more points, or be able to stop us from getting violations in other cases.
...
This is one of the most major changes in this manual update, as it not only greatly reduces the amount of space for the mobile goals, but it also makes it so it will be much easier to tell which mobile goal is considered scored. It is also relevant to note that the placed mobile goal criteria in SC5, and now the 3 criteria are:
