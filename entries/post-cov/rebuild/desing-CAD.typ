...
#align(center)[
  #grid(columns: 2, gutter: 20pt, [
    #figure(image("./imgs/drive from angle.PNG", height: 150pt), caption: [])
  ], [
    #figure(image("./imgs/drive top.png", height:150pt), caption: [])
  ])
]
...
#align(center)[
  ...
  #figure(image("./imgs/Gear meshing .png", height: 150pt), caption: [Gear Reversal])
]
...
#align(center)[
  ...
  #figure(image("./imgs/thing 1.png", height: 150pt), caption: [Gear Reversal])
]
===
...
#align(center)[
  #grid(columns: 2, gutter: 20pt, [
    #figure([#image("./imgs/Bike.jpg", height: 150pt)], caption: [#link("https://en.wikipedia.org/wiki/Tensioner")[Example of tensioner on bike]])
  ],[
    //#image("", height: 210pt)//
    // screen shot of th whole area i just discribed 
      #figure(image("./imgs/area described .png", height: 190pt), caption: [Gear Reveverasl and flex roolers])
    ])
]
== Second Stage Intake
...
#align(center)[
  ...
  #figure(image("./imgs/2 stage intake.png", height: 200pt), caption: [secound stage intake])
]
== Mogo Mech 
...
#align(center)[
  ...
  #figure(image("./imgs/MOGO AND MECH.png", height: 200pt), caption: [Mogo mech forces])
]
==== 
...
//CAD of lbLady brown.png
#align(center)[

  #figure(image("./imgs/Lady brown.png", height: 150pt), caption: [Lady Brown])
]
== Doinker 
...
#align(center)[
  ...
  #figure(image("./imgs/Doinker.png", height: 150pt), caption: [Doinker])
]
//cad of doinker + new plastic
//big picture of whole robot all together
#align(center)[

  #figure(image("./imgs/whole thing.PNG", height: 650pt), caption: [])
]